  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <Button 
          onClick={() => window.open("https://business.facebook.com/messaging/whatsapp/onboard/?app_id=2081734396063574&config_id=3650462835091874&extras=%7B%22version%22%3A%22v4%22%2C%22sessionInfoVersion%22%3A%223%22%2C%22featureType%22%3A%22whatsapp_business_app_onboarding%22%7D&redirect_uri=https%3A%2F%2Fclient.algomatrixai.com%2Fauth%2Fmeta%2Fcallback", "whatsapp_signup", "width=800,height=700")}
          className="bg-[#25D366] hover:bg-[#25D366]/90 text-white font-medium shrink-0 shadow-sm border border-[#25D366]/20"
        >
